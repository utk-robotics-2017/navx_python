...
class AHRSProtocol(IMUProtocol):
    ...
    AHRSPOS_TS_UPDATE_YAW_VALUE_INDEX =              4 # Degrees.  Signed 16:16
    AHRSPOS_TS_UPDATE_PITCH_VALUE_INDEX =            8 # Degrees.  Signed 16:16
    AHRSPOS_TS_UPDATE_ROLL_VALUE_INDEX =            12 # Degrees.  Signed 16:16
    AHRSPOS_TS_UPDATE_HEADING_VALUE_INDEX =         16 # Degrees.  Signed 16:16
    AHRSPOS_TS_UPDATE_ALTITUDE_VALUE_INDEX =        20 # Meters.   Signed 16:16
    AHRSPOS_TS_UPDATE_FUSED_HEADING_VALUE_INDEX =   24 # Degrees.  Signed 16:16
    ...
    AHRSPOS_TS_UPDATE_TIMESTAMP_INDEX =             86  # UINT32, Timestamp (milliseconds)
